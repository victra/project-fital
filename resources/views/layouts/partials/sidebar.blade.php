    ...
    <section class="sidebar">
       ...
       <!--  <form action="#" method="get" class="sidebar-form">
        ...
        <ul class="sidebar-menu">
           ...
           <!--  <li class="{{ (Request::is('*absensisiswa*')) ? 'active':'' }}"><a href="{{ url('absensisiswa') }}"><i class='fa fa-table'></i> <span> Rekap Absensi (Bulan) </span></a></li>
            <li class="{{ (Request::is('*absensisiswa*')) ? 'active':'' }}"><a href="{{ url('absensisiswa') }}"><i class='fa fa-table'></i> <span> Rekap Absensi (Semester) </span></a></li> -->
            <li class="treeview">
