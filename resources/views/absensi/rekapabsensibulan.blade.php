...
@if(Session::has('info_rekapbulan'))
    <!-- <div id="infoRekap" class="alert alert-info"><span class="glyphicon glyphicon-info-sign"></span><em> {!! session('info_rekapbulan') !!}</em><a class="close" data-dismiss="alert" aria-label="close">&times;</a></div> -->
@endif
...
<div class="box">
    ...
    @if(Session::has('info_rekapbulan'))
    <div class="box-body">
        <table id="tablerekapbulan" class="table table-hover table-bordered table-striped dataTable" aria-describedby="tablerekapbulan_info">
