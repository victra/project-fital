...
<script type="text/javascript">
    var t = $('#tablegurupiket').DataTable({
        "scrollY": 400,
        "scrollCollapse": true,
        "processing": true,
        "serverSide": true,
        ...
        "columns": [
          ...
          { data: 'jadwal' , name: 'jadwal' , sWidth: '7%' , orderable: false , searchable: false ,  className: "text-center" },
          { data: 'nip' , name: 'nip' , sWidth: '19%' , searchable: false ,  className: "text-center" },
          { data: 'name' , name: 'name' , sWidth: '25%' },
          { data: 'jkl' , name: 'jkl' , sWidth: '13%' , orderable: false , searchable: false ,  className: "text-center" },
          { data: 'agama' , name: 'agama' , sWidth: '9%' , orderable: false , searchable: false ,  className: "text-center" },
          { data: 'tlp' , name: 'tlp' , sWidth: '13%' , orderable: false , searchable: false ,  className: "text-center" },
          { data: 'action' , name: 'action' , sWidth: '9%' , orderable: false , searchable: false ,  className: "text-center" }
        ],            
        "responsive": true,
        "bAutoWidth": false,
